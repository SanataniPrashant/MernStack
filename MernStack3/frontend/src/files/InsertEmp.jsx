      ...
      <div style={{
        ...
        <Form>
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control type="text" name="empno" onChange={handleInput} style={{
              width: '100%',
              padding: '10px',
              marginBottom: '20px',
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control type="text" name="department" onChange={handleInput} style={{
              width: '100%',
              padding: '10px',
              marginBottom: '20px',
              border: '1px solid #ccc',
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control type="text" name="city" onChange={handleInput} style={{
              width: '100%',
              padding: '10px',
              marginBottom: '20px',
              border: '1px solid #ccc',
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control type="text" name="salary" onChange={handleInput} style={{
              width: '100%',
              padding: '10px',
              marginBottom: '20px',
              border: '1px solid #ccc',
